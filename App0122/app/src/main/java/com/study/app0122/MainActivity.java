...
public class MainActivity extends AppCompatActivity {
    ...
    public void printData(String data){
        ...
        //이시점 부터는 String을 객체화 시켜서 사용해야 한다.
        ...
        for(int i = 0; i < memberList.size(); i++) {
            ...
            Log.d(TAG, "인플래이션 결과 뷰그룹은 "+root_wrapper);
            ...
            TextView t_id = (TextView) text_root.getChildAt(0); //아이디 텍스트 뷰
            TextView t_pass = (TextView)text_root.getChildAt(1); //비밀번호 텍스트 뷰
            TextView t_name = (TextView)text_root.getChildAt(2); //이름 텍스트 뷰
        }
    }
    ...
    public void loadData(View view){
        ...
        //쓰레드는 하나의 프로세스내에서 독립적으로(또한 비동기적 특징도 있음) 실행되는, 또 하나의 세부 실행 단위
        ConnectManager manager = new ConnectManager(this,"http://172.30.1.4:9999/rest/member", null);
        manager.start();
