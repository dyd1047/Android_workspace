...
public class FormActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void callPhone(){
        //우리가 제작중인 현재 앱안에 있는 액티비티가 아니라, 외부 앱의 액티비이면??
        ...
        //해석하는데 도움이 된다..
        Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:01021318782"));
        startActivity(intent);
    }

    //다른 액티비티를 호출하되, 다시 전달받을 것을 염두해두고 코드를 작성..
    public void sendAndGet(){
        Intent intent = new Intent(); //명시하지 않은 이유는? 우리가 원하는건 새롭게 생성된
