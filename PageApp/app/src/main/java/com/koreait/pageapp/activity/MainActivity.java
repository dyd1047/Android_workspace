...
//생명주기 메서드를 제공하여, 개발자로 하여금 제어가 가능하도록..
...
public class MainActivity extends AppCompatActivity {
    ...
    //프레그먼트 매니저를 얻으려면, 현재 액티비티가 Fragment를 지원하는 액티비티여야 한다..
    //우리의 경우 AppCompatActivity이므로 이미 Fragment의 자식이다.. 따라서 그냥 쓰면 된다..
    FragmentManager fragmentManager=this.getSupportFragmentManager();    //프레그먼트 화면을 제어해주는 프레그먼트 트랜잭션을 생성해준다
    int current; //기존의 인덱스
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //이후에 부착해야함
        //FrameLayout ViewGroup이 존재해야 붙일 수 있으므로, setContentView이후에 부착
        ...
        //디폴트로 보여주고 싶은 화면
        showView(2); //노란색 화면 부터..
    }

    public void showPage(View view){
        int index = 0; //보여질 프래그먼트의 인덱스
        switch (view.getId()){
